...
def main():
    ...
    parser.add_argument("--is_llama3_openbiollm", action='store_true', help="Set this flag if the model is Llama3-OpenBioLLM-70B to use a specific prompt format")
    ...
    for specialty, datapoints_list in data.items():
        for idx, item in enumerate(datapoints_list):
            ...
            for shuffle_idx in range(10):  # 10 samples per item
        ...
        for i in range(0, len(batch_items), BATCH_SIZE):
            ...
            for b_idx, item in enumerate(current_batch):
                ...
                response_data = {
                    ...
                    "shuffled_options": shuffled_options,  # Fix: use shuffled_options here, not item["shuffled_options"]
